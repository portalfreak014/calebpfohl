...
| Arabic | English |
| --- | --- |
| احتلَّ / يحتل / احتلال | to occupy |
| أخضع / يخضع / إخضاع | to subject; to subjugate |
| أدرك / يُدرك / إدراك | to realize |
| ازدهر / يزدهر / ازدهار | to flourish |
| أصلح / يصلح / إصلاح | to reform |
| اهتمام / اهتمامات | concern(s) |
| أهمية | importance |
| بعثة / بعثات | scholarship(s) |
| تأمَّل / يتأمل / تأمُّل | to reflect, meditate |
| تصميم / تصميمات - تصاميم | design(s) |
| تعلَّق / يتعلّق / تعلُّق | to relate to |
| تفاعل / تفاعلات | interaction(s) |
| جذري | radical |
| حاسم | decisive |
| حِصة / حِصص | portion(s), allocation(s) |
| خريج | graduate |
| خلق / يخلق / خلق | to create |
| رسم / رسوم تشكيلية | visual/fine arts |
| رِضى | satisfaction |
| رَضي / يَرْضى / رِضى | to be satisfied |
| زخرف / يزخرف / زخرفة | to ornament, decorate |
| سائد | predominant |
| ضبط / ضوابط | control(s), regulation(s) |
| طاقة استيعابية / طاقات | capacity(ies) |
| طُموح / طموحات | ambition(s) |
| طَوَّرَ / يُطَوِّرُ / تَطوير | to develop, improve |
| عقبة / عقبات | obstacle(s) |
| على سبيل المثال | as an example |
| فن / فنون | art(s) |
| قادر | able |
| قدرة / قدرات | ability(ies) |
| قطاع عام | public sector |
| كمن (في) / يكمن / كمون | to be hidden in, latent |
| لبى / يلبي / تلبية | to respond |
| متخصص | specialist |
| مثقف | educated |
| مشروع / مشاريع | project(s) |
| مَشَى / يمشِى / مَشْى | to go together |
| منهج / مناهج | curriculum(a) |
| مهمة / مهام - مهمات | mission(s) |
| نَقَّحَ / يُنَقِّحُ / تَنقيح | to revise, improve, refine |
| هيّأ / يُهيِّ / تهيئة | to prepare |
| تواصل / يتواصل / تواصل | to communicate |
| واكب / يواكب / مواكبة | to occur at the same time |
| ينبغي | must |
...
| Arabic | English |
| --- | --- |
| أتم / يتم / إتمام | to complete |
| احْتَجَّ / يَحْتَجُّ / احْتِجاج | symbolic |
| احتمال | probability |
| أخذ بعين الاعتبار / يأخذ / أخذ | to take into consideration |
| ارْتَقى ب / يَرْتَقي / ارْتِقاء | to upgrade, advance |
| استأذن / يستأذن / استئذان | to ask permission |
| اسْتَجابَ / يَسْتَجِيبُ / استجابة | to respond |
| استدعى / يستدعي / استدعاء | to call up, to summon |
| اعتدى (على) / يعتدي / اعتداء | to assault |
| انتقم / ينتقم / انتقام | to take revenge |
| انْضَبَط / يَنْضَبِط / انْضِباط | to be disciplined |
| انْطَبَقَ / يَنْطَبِقُ / انْضِباق | to be applicable to |
| انْفَتَحَ / يَنْفَتِحُ / انفتاح | to open up |
| بمثابة | as |
| بيئة / بيئات | environment(s) |
| تجربة / تجارب | experiment, experience(s) |
| تجربة حياتية | life experience |
| تشاجر / يتشاجر / تشاجر | to quarrel |
| تَطَلَّعَ / يَتَطَلَّعُ / تَطَلُّع | to look forward to |
| تَعامَل مع / يَتَعامَل / تَعامُل | to deal with |
| تفاقم / يتفاقم / تفاقم | to get worse, deteriorate |
| تَنَاسَبَ / يَتَناسَبُ / تَناسُب | to be suited for/to be suitable |
| تنازل (عن) / يتنازل / تنازل | to give up, forego |
| جدية | seriousness |
| حتماً | decidedly, definitely |
| حرم / يحرم / حرمان | to deprive |
| حرية مطلقة | absolute (complete) freedom |
| حصَّل / يُحَصِّل / تَحْصيل علمي | to achieve, achievement |
| حفَّزَ / يحفِّز / تحفيز | to entice, to provide incentive |
| حياتيّ | to do with life |
| خلفية | background |
| خيار / خيارات | choice(s) |
| دافِع / دوافع | incentive(s) |
| رمزيّ | symbolic |
| روَّح / يُرَوِّحُ / ترويح | to refresh, to relax |
| روح المشاركة | spirit of participation, partnership |
| سَانَد / يُسَانِدُ / مُسَانَدَة | to support |
| سلوك | behavior, conduct |
| شر / شرور | evil(s) |
| ضجة | noise, outcry |
| طعن / يطعن / طعن | to stab |
| ظاهرة / ظواهر | phenomenon(a) |
| عالَج / يُعالِجُ / مُعالَجَة - عِلاج | to handle, to treat |
| عامل / عوامل | factor(s) |
| عدا | except |
| عراك | quarrel |
| عقل / عقول | mind(s) |
| على السواء | equally, likewise |
| عنف | violence |
| فَصَلَ / يَفْصِلُ / فَصْل | to dismiss |
| قدرة عقلية | mental ability |
| قضية / قضايا | problem(s), issue(s) |
| قيَّم / يقيِّم / تقييم | to evaluate |
| لَجَأ إلى / يَلْجَأُ / لُجوء | to resort to |
| لم يكد | no sooner than, as soon as … |
| مبدأ / مبادئ | principle(s) |
| متخلف | falling behind |
| متزايدة | increasing |
| متسامح | tolerant |
| محروم | deprived |
| مرونة | flexibility |
| مسبقا | previously, beforehand |
| مستوى | standard, level |
| مشاغب | troublemaker |
| مطلق | absolute |
| موحد | unified, uniform |
| نفسي | psychological |
| وديّ | friendly |
